...
if predict:
    ...
    if result == "Yes":
        ...
        <div class="high-risk">
            ...
            <p>
                This employee shows a high likelihood of leaving the organization.
        ...
        <div class="low-risk">
            ...
            <p>
                This employee is likely to remain with the organization.
                No immediate action is required.
            </p>
        </div>
        """, unsafe_allow_html=True)
else:
    st.info("Fill employee details from sidebar and click Predict")
